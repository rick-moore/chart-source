...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('keypress', '#genre_input', function (e) {
  if (e.key == 'Enter') {
    e.preventDefault();
...
$(document).on('click', '#add_tag_button', function () {
  ...
  if (tag != '') {
    $('#genre_list').append("<span class=\"tag_span\">".concat(tag, "<button type='button' class='remove_tag'>X</button></span>"));
    $('#genre_input').val('');
  }
});
...
/******/ });
//# sourceMappingURL=genretool-fd387a0a27b14ec6ba38.js.map